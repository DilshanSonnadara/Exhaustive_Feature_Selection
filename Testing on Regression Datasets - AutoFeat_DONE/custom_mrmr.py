...
class MRMR(BaseSelector):
    ...
    def fit(self, X: pd.DataFrame, y: pd.Series):
        ...
        # Added these two lines of code
        self.selected_features_.append(feature)
        self.mrmr_scores_.append(self.relevance_[n])
        ...
        for i in range(iter):
            ...
            self.selected_features_.append(feature)          # <-- add this
            self.mrmr_scores_.append(mrmr[n])                # <-- and this
        ...
        self.selected_features_.append(remaining[n])
        self.mrmr_scores_.append(mrmr[n])
